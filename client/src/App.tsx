...
//   const [err, serErr] = useState<any>(null);
...
//   const handleSignIn = () => {
//     // Create a request payload with the username and password
//     const payload = {
//       username: username,
//       password: password
//     };

//     // Send a POST request to the server to authenticate the user and retrieve the JWT token
...
//       .then((res) => res.json())
//       .then((data) => {
//         // Assuming the server responds with a JWT token in the "token" property of the response data
